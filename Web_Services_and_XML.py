...
# similar to http://www.pythonlearn.com/code/geoxml.py.
...
# Actual data: http://python-data.dr-chuck.net/comments_236583.xml (Sum ends with 33)
...
# Parsing xml using tree structure
tree = ET.fromstring(xml)
# Finding all under comments/comment
lst = tree.findall('comments/comment')
# Counting total number of count line
print 'Count:', len(lst)
