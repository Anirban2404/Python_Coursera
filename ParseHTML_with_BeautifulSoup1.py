...
# Actual data: http://python-data.dr-chuck.net/comments_236586.html (Sum ends with 20)
...
# of the span tag, convert them to integers and add them up to complete the assignment.
# Sample Execution
...
# If URL is null take http://python-data.dr-chuck.net/comments_42.html
# as the default URL
if len(url) < 1:
